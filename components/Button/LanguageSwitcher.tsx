  ...
  return (
    ...
    >
      <div className="relative z-10 flex items-center gap-3">
        <Globe className='text-white transition-transform duration-400 group-hover:rotate-180'/>
        <p className="max-w-0 opacity-0 group-hover:max-w-[3rem] group-hover:opacity-100 transition-all duration-400 whitespace-nowrap overflow-hidden text-white font-semibold tracking-wide">
